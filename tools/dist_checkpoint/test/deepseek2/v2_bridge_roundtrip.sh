#! /bin/bash
# HF Checkpoint Roundtrip Test — DeepSeek-V2
...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/loongforge-ckpt/DeepSeek-V2"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/loongforge-ckpt/deepseek-v2-roundtrip-output"}
...
echo "========================================"
echo "HF Roundtrip Test — DeepSeek-V2"
