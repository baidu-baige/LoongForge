...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/aiak-ckpt/LLaVA-OneVision-1.5-4B-stage0"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/aiak-ckpt/llavaov1.5-4b-roundtrip-output"}
