#! /bin/bash
# HF Checkpoint Roundtrip Test — Qwen3-Coder-30B-A3B
...
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/loongforge-ckpt/qwen3-coder-roundtrip-output"}
...
echo "========================================"
echo "HF Roundtrip Test — Qwen3-Coder-30B-A3B"
