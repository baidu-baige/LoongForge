#! /bin/bash
# HF Checkpoint Roundtrip Test — Qwen3-8B
...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/aiak-ckpt/Qwen3-8B-Instruct"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/aiak-ckpt/qwen3-8b-roundtrip-output"}
...
TRAINING_ARGS=(
    ...
    --yaml-file $AIAK_TRAINING_PATH/tools/dist_checkpoint/demo/qwen3/qwen3_8b.yaml
)
...
echo "========================================"
echo "HF Roundtrip Test — Qwen3-8B"
