...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/aiak-ckpt/Qwen2.5-VL-32B-Instruct/"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/aiak-ckpt/qwen2.5-vl-32b-roundtrip-output"}
...
MODEL_PARALLEL_ARGS=(
    ...
    --custom-pipeline-layers 16,16,16,16
