...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/aiak-ckpt/Qwen2.5-VL-7B-Instruct/"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/aiak-ckpt/qwen2.5-vl-7b-roundtrip-output"}
...
MODEL_ARGS=(
    ...
    --config-file configs/models/qwen2.5vl/qwen2_5_vl_7b.yaml
    --rotary-base 1000000
