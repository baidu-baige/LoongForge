...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/loongforge-ckpt/mimo-7b"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/loongforge-ckpt/mimo-7b-roundtrip-output"}
...
echo "========================================"
echo "HF Roundtrip Test — Mimo-7B"
