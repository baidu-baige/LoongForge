...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/loongforge-ckpt/InternVL2_5-8B/"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/loongforge-ckpt/internvl2.5-8b-roundtrip-output"}
