...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/aiak-ckpt/InternVL2_5-8B/"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/aiak-ckpt/internvl2.5-8b-roundtrip-output"}
