...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/aiak-ckpt/InternVL2_5-26B/"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/aiak-ckpt/internvl2.5-26b-roundtrip-output"}
