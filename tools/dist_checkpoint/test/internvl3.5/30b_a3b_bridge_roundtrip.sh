...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/aiak-ckpt/InternVL3_5-30B-A3B/"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/aiak-ckpt/internvl3.5-30b-a3b-roundtrip-output"}
...
MODEL_ARGS=(
    --model-name internvl3_5-30b-a3b
    --rotary-base 1000000
