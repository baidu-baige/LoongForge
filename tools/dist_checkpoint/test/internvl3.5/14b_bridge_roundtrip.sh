...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/aiak-ckpt/InternVL3_5-14B/"}
SAVE_HF_PATH=${SAVE_HF_PATH:-"/workspace/aiak-ckpt/internvl3.5-14b-roundtrip-output"}
