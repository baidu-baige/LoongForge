...
from loongforge.datasets.world.dreamzero.dataset.datasets import (
...
from loongforge.datasets.world.dreamzero.transforms.base import (
    ComposedModalityTransform,
)
from loongforge.datasets.world.dreamzero.transforms.concat import (
    ConcatTransform,
)
from loongforge.datasets.world.dreamzero.transforms.state_action import (
    StateActionToTensor,
    StateActionTransform,
)
from loongforge.datasets.world.dreamzero.transforms.video import (
    VideoColorJitter,
    VideoCrop,
    VideoResize,
    VideoToNumpy,
...
def _load_vae_module():
    path = _REPO_ROOT / "loongforge/models/world/dreamzero/modules/wan_video_vae.py"
