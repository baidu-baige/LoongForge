...
from loongforge.datasets.multimodal import MultiMixQASample
from loongforge.datasets.multimodal.base.task_encoder import (
    BaseTaskEncoder,
    BaseTaskSample,
...
from loongforge.datasets.multimodal.ernie.tokenizer_vl import (
    Ernie45VLTokenizer,
    special_tokens_info as ERNIE_SPECIAL_TOKENS_INFO,
)
from loongforge.datasets.multimodal.ernie.chat_template_utils import (
    apply_chat_training_template,
)
from loongforge.datasets.multimodal.ernie.example_to_feature import (
    ExampleToFeature,
)
from loongforge.datasets.multimodal.ernie.image_preprocessor import (
    AdaptiveImageProcessor,
)
from loongforge.datasets.multimodal.ernie.image_modification import (
...
class ErnieTaskEncoder(BaseTaskEncoder):
    ...
    def encode_multi_mix_qa(self, sample: MultiMixQASample) -> ErnieTaskSample:
        ...
        if images and len(image_meta) > 0:
            from loongforge.datasets.multimodal.ernie.image_modification import VisionExample
