...
def _default_strategy_builder() -> Callable:
    from loongforge.datasets.common.lerobot_dataset import (
...
def _fastwam_strategy_builder() -> Callable:
    from loongforge.datasets.world.fastwam import (
...
def _lingbot_va_strategy_builder() -> Callable:
    from loongforge.datasets.world.lingbot_va import build_lingbot_dataset

    return build_lingbot_dataset


def _groot_n1_7_strategy_builder() -> Callable:
    from loongforge.datasets.robotics.groot_n1_7 import (
...
def _cosmos3_droid_strategy_builder() -> Callable:
    from loongforge.datasets.world.cosmos3 import (
        build_droid_dataset,
    )
...
def _dreamzero_strategy_builder() -> Callable:
    from loongforge.datasets.world.dreamzero.builder import (
...
def _wall_oss_0_5_strategy_builder() -> Callable:
    from loongforge.datasets.robotics.wall_oss_0_5 import (
