...
from loongforge.engines.mcore.global_vars import (get_hydra_config,
                                                  set_args_dict,
                                                  set_data_config,
                                                  set_hydra_config,
                                                  set_model_config)
from loongforge.engines.mcore.utils import get_config_from_file
...
def _register_selective_fp8_decision():
    ...
    """
    try:
        from loongforge.engines.mcore.fp8_dynamic_policy import selective_fp8_init_decision
