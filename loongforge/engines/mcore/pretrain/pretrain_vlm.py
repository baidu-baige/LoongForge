...
from loongforge.engines.mcore import constants, get_args, get_model_config
...
from loongforge.engines.mcore.global_vars import get_model_config
...
def get_cpu_offload_manager():
    ...
    if _cpu_offload_manager is None:
        from loongforge.engines.mcore.full_hetero_cpu_offload import CpuOffloadManager
