...
def _build_tokenizer(args) -> Optional["MegatronLegacyTokenizer"]:
    ...
    _ensure_var_is_not_initialized(_GLOBAL_LOONGFORGE_TOKENIZER, "loongforge.engines.mcore.tokenizer")
...
def get_tokenizer() -> Optional["MegatronLegacyTokenizer"]:
    """Return tokenizer."""
    _ensure_var_is_initialized(_GLOBAL_LOONGFORGE_TOKENIZER, "loongforge.engines.mcore.tokenizer")
    return _GLOBAL_LOONGFORGE_TOKENIZER
