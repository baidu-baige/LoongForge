...
Usage::
    ...
    from loongforge.evaluation.factories.registry import build_model_spec
...
def _auto_import_factory_modules() -> None:
    ...
    _FACTORY_MODULES = [
        "loongforge.evaluation.factories.pi05_factory",
        "loongforge.evaluation.factories.xvla_factory",
        "loongforge.evaluation.factories.groot_n1_6_factory",
        "loongforge.evaluation.factories.groot_n1_7_factory",
        "loongforge.evaluation.factories.lingbot_va_factory",
        "loongforge.evaluation.factories.dreamzero_factory",
        "loongforge.evaluation.factories.fastwam_factory",
    ]
