...
from loongforge.evaluation.adapters.calvin import CALVIN_MAX_STEPS_PER_SUBTASK, CalvinAdapter
from loongforge.evaluation.action_decoders import ActionDecoder
from loongforge.evaluation.metrics import append_jsonl, load_jsonl
from loongforge.evaluation.orchestrator.config import (
    build_rpc_payload,
)
from loongforge.evaluation.orchestrator.runners import _common
from loongforge.evaluation.orchestrator.runners._common import StepTimeoutError, alarm_timeout, avg as _avg
from loongforge.evaluation.payload_builders import PayloadBuilder
from loongforge.evaluation.protocol import PROTOCOL_VERSION
from loongforge.evaluation.transport import PolicyClient
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-dir",
        default="/workspace/LoongForge-VLA/loongforge/evaluation/reports/manual/calvin/runner",
    )
    return parser
