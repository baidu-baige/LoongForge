...
def _auto_import_decoder_modules() -> None:
    ...
    for mod in (
        "loongforge.evaluation.embodied.action_decoders.ee6d",
        "loongforge.evaluation.embodied.action_decoders.ee_quat",
        "loongforge.evaluation.embodied.action_decoders.joint",
    ):
        try:
