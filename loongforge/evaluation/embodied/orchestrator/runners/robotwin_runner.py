...
from loongforge.evaluation.embodied.orchestrator.config import load_config
...
def _write_deploy_policy(args: argparse.Namespace, path: pathlib.Path) -> None:
    ...
    fields: Dict[str, object] = {
        "policy_name": "loongforge.evaluation.embodied.bridges.robotwin_policy",
...
def build_command(
    ...
    return [
        ...
        str(args.seed),
        "--policy_name",
        "loongforge.evaluation.embodied.bridges.robotwin_policy",
    ]
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--eval-root",
        default=os.environ.get("EVAL_ROOT", "/workspace/LoongForge-VLA/loongforge/evaluation/embodied"),
    )
    ...
    parser.add_argument(
        "--output-dir",
        default="/workspace/LoongForge/loongforge/evaluation/embodied/reports/manual/robotwin/official_eval",
    )
