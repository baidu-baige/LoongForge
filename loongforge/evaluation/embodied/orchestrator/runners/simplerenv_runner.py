...
from loongforge.evaluation.embodied.adapters.simplerenv import (
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-dir",
        default="/workspace/LoongForge/loongforge/evaluation/embodied/reports/manual/simplerenv/smoke",
    )
