...
from loongforge.evaluation.embodied.adapters.calvin import CALVIN_MAX_STEPS_PER_SUBTASK, CalvinAdapter
from loongforge.evaluation.embodied.action_decoders import ActionDecoder
from loongforge.evaluation.embodied.metrics import append_jsonl, load_jsonl
from loongforge.evaluation.embodied.orchestrator.config import (
    build_rpc_payload,
)
from loongforge.evaluation.embodied.orchestrator.runners import _common
from loongforge.evaluation.embodied.orchestrator.runners._common import StepTimeoutError, alarm_timeout, avg as _avg
from loongforge.evaluation.embodied.payload_builders import PayloadBuilder
from loongforge.evaluation.embodied.protocol import PROTOCOL_VERSION
from loongforge.evaluation.embodied.transport import PolicyClient
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-dir",
        default="/workspace/LoongForge/loongforge/evaluation/embodied/reports/manual/calvin/runner",
    )
    return parser
