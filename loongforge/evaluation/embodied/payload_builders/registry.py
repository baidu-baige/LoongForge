...
def _auto_import_payload_builder_modules() -> None:
    ...
    _MODULES = [
        "loongforge.evaluation.embodied.payload_builders.pi05",
        "loongforge.evaluation.embodied.payload_builders.xvla",
        "loongforge.evaluation.embodied.payload_builders.groot_n1_6",
        "loongforge.evaluation.embodied.payload_builders.groot_n1_7",
        "loongforge.evaluation.embodied.payload_builders.lingbot_va",
        "loongforge.evaluation.embodied.payload_builders.dreamzero",
        "loongforge.evaluation.embodied.payload_builders.fastwam",
    ]
    for mod in _MODULES:
        try:
