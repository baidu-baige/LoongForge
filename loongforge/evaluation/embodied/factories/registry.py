...
Usage::
    ...
    from loongforge.evaluation.embodied.factories.registry import build_model_spec
...
def _auto_import_factory_modules() -> None:
    ...
    _FACTORY_MODULES = [
        "loongforge.evaluation.embodied.factories.pi05_factory",
        "loongforge.evaluation.embodied.factories.xvla_factory",
        "loongforge.evaluation.embodied.factories.groot_n1_6_factory",
        "loongforge.evaluation.embodied.factories.groot_n1_7_factory",
        "loongforge.evaluation.embodied.factories.lingbot_va_factory",
        "loongforge.evaluation.embodied.factories.dreamzero_factory",
        "loongforge.evaluation.embodied.factories.fastwam_factory",
    ]
