...
2. **Get the weights and edit the config** — download [lerobot/pi05_libero_finetuned_v044](https://huggingface.co/lerobot/pi05_libero_finetuned_v044), then fill the `/path/to/...` placeholders in `examples/vla/pi05/eval/configs/libero/object_smoke.yaml`. A field-by-field example: the [user guide](docs/user_guide_en.md#2-quick-start); the config layout: [user guide §3](docs/user_guide_en.md#3-configuration-reference).
