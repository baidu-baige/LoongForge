...
from loongforge.embodied.train.trainers.optimizer_state_shard.fp8_parameter_sync import (
    dequantize_into,
    quantize_into,
    validate_runtime,
)

from loongforge.embodied.train.trainers.optimizer_state_shard.layout import (
    WHOLE_TENSOR,
...
class ParameterSynchronizer:
    ...
    def _build_plan(self):
        ...
        assert_plan_matches_ranks(
            ...
            "optimizer-state-shard parameter-sync plan differs across ranks; refusing to run "
