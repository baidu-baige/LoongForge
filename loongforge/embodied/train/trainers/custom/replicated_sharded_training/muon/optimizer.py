...
#
# Modified from VeRL under the Apache-2.0 License and llama-recipes under the Llama 2 Community License.
...
def is_torch_npu_available() -> bool:
    """True when the ``torch_npu`` package is installed (Ascend NPU backend)."""
