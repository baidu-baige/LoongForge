...
from loongforge.embodied.train.trainers.custom.lingbot_vla_v2.lingbot_vla_v2_optimizer_state_shard_trainer import (
    LingbotVlaV2OptimizerStateShardTrainer,
)
...
MODEL_SCHEMA = {
    ...
    "lingbot_vla_v2": ModelSchema(
        ...
        LingbotVLAV2ModelConfig,
        LingbotVLAV2DataConfig,
        trainer_cls=LingbotVlaV2OptimizerStateShardTrainer,
    ),
