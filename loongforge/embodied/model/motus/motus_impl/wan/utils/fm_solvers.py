...
"""DPM-Solver multistep scheduler adapted for flow matching, with helpers for sigma and timestep setup."""
...
def get_sampling_sigmas(sampling_steps, shift):
    """Build a shifted linear sigma schedule for the given number of sampling steps."""
...
def retrieve_timesteps(
    ...
    **kwargs,
    ...
    """Call the scheduler's `set_timesteps` with custom timesteps/sigmas and return timesteps and count."""
