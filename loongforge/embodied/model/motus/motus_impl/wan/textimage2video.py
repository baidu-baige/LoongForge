...
"""Wan unified text/image-to-video (TI2V) generation pipeline."""
import gc
import logging
import math
import os
...
class WanTI2V:
    """Unified TI2V pipeline that dispatches to text-to-video or image-to-video generation."""
    ...
    def t2v(self,
        ...
        @contextmanager
        def noop_no_sync():
            """Fallback no-op context manager used when the model lacks a `no_sync` method."""
            yield
