...
This is the LingBot instance of the shared, config-driven optimizer-state-shard policy. It only
...
The concrete downcast dtype (bf16 vs fp8) is resolved in the optimizer-state-shard registry from
...
class LingbotVlaV2ParameterPolicy(MarkerParameterPolicy):
    """Preserve the validated LingBot optimizer-state-shard ownership and precision contract."""
