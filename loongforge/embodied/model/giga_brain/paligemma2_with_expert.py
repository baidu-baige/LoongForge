...
# giga_models/models/vla/giga_brain_0/paligemma2_with_expert.py, unmodified.
# Defines the PaliGemma2 + action-expert dual-stream backbone
# (Gemma2DecoderLayerWithExpert / SiglipEncoderLayer are the FSDP wrap units
# for this model, matching the reference giga-train FSDP config).
