...
from loongforge.engine.native.optimizer.dmuon import build_dmuon_optimizer
...
def build_optimizer(model: nn.Module, training_args) -> torch.optim.Optimizer:
    ...
    if optimizer_name.lower() == "dmuon":
        groups = build_param_groups(unwrap_model(model), training_args) if training_args.lr_group else None
