...
"""DataLoader factory for Native training."""
...
from loongforge.datasets.common.sampler_builder import build_sampler
from loongforge.datasets.common.transforms.collator import build_preprocessor
from loongforge.datasets.common.transforms.pipeline import build_transforms_from_args
...
def _build_dataset(model_cfg, data_cfg, training_args, dataset_format: str):
    ...
    if dataset_format == "lerobot_datasets":
        from loongforge.datasets.common.dataset_builder import build_dataset_by_strategy

        return build_dataset_by_strategy(model_cfg, data_cfg, training_args)

    if dataset_format == "hdf5_datasets":
        from loongforge.datasets.common.hdf5_dataset import build_hdf5_dataset

        return build_hdf5_dataset(model_cfg, data_cfg, training_args)

    if dataset_format == "dummy_datasets":
        from loongforge.datasets.common.dummy_dataset import build_dummy_dataset
