...
from loongforge.engine.native.optimizer.optimizer import build_optimizer as build_generic_optimizer
    ...
    class GrootCapturableAdamW(_TEFusedAdam):
        ...
        def step(self, closure=None, grad_scaler=None):
            ...
            for group in self.param_groups:
                ...
                if self.capturable:
                    from loongforge.engine.native.trainers.custom.groot_n1_7.groot_fused_adamw import (
...
def build_groot_optimizer(model, training_args, *, capturable: bool = True):
    ...
    groups = build_param_groups(unwrap_model(model), training_args)
    if capturable:
        for group in groups:
