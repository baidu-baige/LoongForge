...
from loongforge.checkpoint.mcore.checkpointing import load_checkpoint, _load_checkpoint_from_path
...
from loongforge.checkpoint.mcore.checkpointing import (
    load_checkpoint,
    save_checkpoint,
    checkpoint_exists,
)
...
from loongforge.engine.mcore import global_vars
...
from loongforge.engine.mcore.dp_balance.train_hooks import (
    train_step_decorator,
    train_log_decorator
)


from loongforge.checkpoint.manifest import is_hf_checkpoint
...
def train_step(
    ...
    if args.enable_full_hetero_dp:
        ...
        from loongforge.engine.mcore.pretrain.pretrain_vlm import (
        ...
        if args.full_hetero_dp_cpu_offload:
            from loongforge.engine.mcore.pretrain.pretrain_vlm import get_cpu_offload_manager
            from loongforge.engine.mcore.full_hetero_cpu_offload import offload_list_items
...
def dump_model_input_example_once(
    ...
    from loongforge.engine.mcore.global_vars import get_tokenizer as get_loongforge_tokenizer
