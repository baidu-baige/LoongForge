...
from loongforge.engine.mcore.global_vars import get_args, get_model_config, get_tokenizer
from loongforge.utils import constants
from loongforge.datasets.text import DataCollatorForSupervisedDataset
from loongforge.tokenizer import AutoTokenizerFromHF
from loongforge.checkpoint.mcore.checkpointing import get_checkpoint_name, read_tracker_iteration
...
def build_full_hetero_encoder_data_iterator(
    ...
    """
    from loongforge.datasets.common.encoder_strided_sampler import EncoderStridedSampler
    ...
    from loongforge.datasets.common.encoder_strided_sampler import PrefetchIterator
    from loongforge.engine.mcore.initialize import get_num_micro_batches_per_decoder_dp
