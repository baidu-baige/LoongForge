...
from loongforge.datasets.text import get_support_templates
...
def _add_log_tensor_args(parser):
    ...
    Example:
        python -m loongforge train --enable-log-tensor \\
...
def _add_extra_model_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        ...
        help="Name identifier for the model architecture. Must match a registered model "
             "in models/catalog.py. Example: 'llama2-7b', 'qwen2-7b'. Default: None"
    )
