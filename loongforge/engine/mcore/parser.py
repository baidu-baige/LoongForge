...
from loongforge.models.common.utils import build_model_config
from loongforge.engine.mcore.arguments import loongforge_extra_train_args_provider
from loongforge.engine.mcore.get_loss_func import (default_loss_func,
                                                    loss_func_internvl)
from loongforge.engine.mcore.get_position_idx_func import (get_mrope_index,
                                                            get_position_ids, 
                                                            get_rope_index_internvl, 
                                                            get_rope_index_qwen3vl)
from loongforge.engine.mcore.validators import (validate_loongforge_extra_args,
...
def parse_arguments(
    ...
    if hasattr(args, "model_name") and args.model_name is not None:
        model_spec = get_model_spec(args.model_name, "mcore")
        args.config_path, args.config_name = str(model_spec.config_file.parent), model_spec.config_file.stem
...
def _register_selective_fp8_decision():
    ...
    """
    try:
        from loongforge.engine.mcore.fp8_dynamic_policy import selective_fp8_init_decision
