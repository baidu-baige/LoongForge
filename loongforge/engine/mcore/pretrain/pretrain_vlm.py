...
from loongforge.engine.mcore.global_vars import get_args, get_model_config
...
from loongforge.engine.mcore.training_utils import dump_model_input_example_once
from loongforge.engine.mcore.sft.utils import (
    build_sft_data_collator,
    build_sft_cyclic_iterators,
)
from loongforge.engine.mcore.dataloader_provider import (
    get_train_dataset,
    get_val_dataset,
    get_train_loader,
    VLMPretrainCollator,
)
from loongforge.datasets.multimodal import build_task_encoder
from datasets import load_from_disk

from megatron.core import parallel_state

from loongforge.models.vlm.omni_model_provider import (
    omni_model_provider,
)
from loongforge.models.vlm.utils import get_batch_on_this_cp_rank
from loongforge.engine.mcore.get_loss_func import default_loss_func
from loongforge.engine.mcore.initialize import (
...
def get_cpu_offload_manager():
    ...
    if _cpu_offload_manager is None:
        from loongforge.engine.mcore.full_hetero_cpu_offload import CpuOffloadManager
...
def train_valid_test_dataset_provider(train_val_test_num_samples, vp_stage=None):
    ...
    import loongforge.engine.mcore.dp_balance.patches
