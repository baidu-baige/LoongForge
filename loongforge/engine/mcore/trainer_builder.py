...
from loongforge.engine.mcore.global_vars import get_hydra_config
...
def register_model_trainer(
    ...
    Args:
        model_family: need to be consistent with the models.mcore_registry definition, otherwise it
