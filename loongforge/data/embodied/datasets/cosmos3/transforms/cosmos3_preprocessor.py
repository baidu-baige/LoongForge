...
from loongforge.data.embodied.datasets.transforms.collator import BasePreprocessor, register_preprocessor
from loongforge.models.embodied.cosmos3.sequence_packing import SequencePlan
...
class DeferredVideoTail:
    ...
    def _augment(self, stack: torch.Tensor, rng_state: torch.Tensor) -> torch.Tensor:
        ...
        """
        from loongforge.data.embodied.datasets.cosmos3.droid_lerobot_dataset import (
