...
def _load_text_encoder(args: argparse.Namespace, device: str, dtype: torch.dtype):
    ...
    from loongforge.models.embodied.fastwam.wan.loader import _load_registered_model, _resolve_configs
    from loongforge.models.embodied.fastwam.wan.text_encoder import HuggingfaceTokenizer
