...
class MiniCPMV46VisionConfig(BaseModelConfig):
    ...
    def __post_init__(self) -> None:
        """Finalize the config through PretrainedConfig and TransformerConfig."""
...
class MiniCPMV46MergerConfig(BaseModelConfig):
    ...
    def __post_init__(self) -> None:
        """Finalize the merger config through the shared base config hook."""
