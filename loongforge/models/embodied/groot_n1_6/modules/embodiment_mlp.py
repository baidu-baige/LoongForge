"""Embodiment-conditioned MLP modules for multi-embodiment support.
...
class SinusoidalPositionalEncoding(nn.Module):
    ...
    def forward(self, timesteps):
        """Generate sinusoidal positional encodings for input timesteps."""
        # timesteps: shape (B, T)
...
class SmallMLP(nn.Module):
    """
    A small multi-layer perceptron (MLP) with ReLU activation.
    """
