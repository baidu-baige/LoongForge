...
from .sequence_packing import ModalityData, PackedSequence
...
def get_context_parallel_last_hidden_state(packed_outputs, **kwargs):
    ...
    from loongforge.models.embodied.cosmos3.sequence_packing import get_all_seq
    return get_all_seq(packed_outputs)


class Cosmos3VFMNetworkConfig(PretrainedConfig):
    """Configuration for Cosmos3 VFM network."""
...
class Cosmos3VFMNetwork(PreTrainedModel):
    """Cosmos3 Video Foundation Model network."""
    ...
    def __init__(self, language_model, config: Cosmos3VFMNetworkConfig):
        ...
        self.natten_parameter_list = config.natten_parameter_list
    ...
    def init_weights(self, buffer_device: torch.device | None):
        """Initialize generation pathway weights."""
    ...
    def patchify_and_pack_latents(
        ...
        """Patchify and pack latents into a single tensor."""
    ...
    def unpatchify_and_unpack_latents(
        ...
        """Unpatchify and unpack latents from packed tensor."""
        p = self.latent_patch_size
