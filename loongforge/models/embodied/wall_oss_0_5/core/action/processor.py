...
from loongforge.models.embodied.wall_oss_0_5.core.action.head import SinusoidalPosEmb
from loongforge.models.embodied.wall_oss_0_5.core.action.normalizer import print_rank_last
...
class ActionProcessor(nn.Module):
    ...
    def __init__(self, config):
        ...
        print_rank_last(
            f"self.dof_config: {self.dof_config}; action_dim: {self.action_dim}; self.agent_pos_config: "
            f"{self.agent_pos_config}; propri_dim: {self.propri_dim}"
        )
