...
from loongforge.engines.torch.global_vars import get_model_config, get_training_args
...
class WallOss05Model(nn.Module):
    ...
    def on_train_begin(self, *, ctx) -> None:
        ...
        from loongforge.models.embodied.wall_oss_0_5.wall_oss_05_fused_ops import log_backend_inventory
