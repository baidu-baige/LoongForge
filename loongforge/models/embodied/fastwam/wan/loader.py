...
"""Load Wan2.2 pretrained components for the local FastWAM implementation."""
...
from loongforge.models.embodied.fastwam.utils.io import ModelConfig, hash_model_file, load_state_dict
from loongforge.models.embodied.fastwam.utils.state_dict import wan_video_vae_state_dict_converter
from loongforge.models.embodied.fastwam.wan.dit import WanVideoDiT
from loongforge.models.embodied.fastwam.wan.text_encoder import HuggingfaceTokenizer, WanTextEncoder
from loongforge.models.embodied.fastwam.wan.vae import WanVideoVAE38, set_rmsnorm_impl
...
class Wan22LoadedComponents:
    """Container for loaded Wan2.2 modules and their source paths."""
...
WAN22_MODEL_REGISTRY = [
    {
        # Example: ModelConfig(model_id="Wan-AI/Wan2.1-T2V-14B", origin_file_pattern="models_t5...")
        "model_hash": "9c8818c2cbea55eca56c7b447df170da",
        "model_name": "wan_video_text_encoder",
        "model_class": WanTextEncoder,
    },
    {
        # Example: ModelConfig(model_id="Wan-AI/Wan2.2-TI2V-5B", origin_file_pattern="diffusion...")
...
def _validate_dit_config(dit_config: dict[str, Any]) -> dict[str, Any]:
    """Validate WanVideoDiT constructor keys from external config."""
...
def _load_registered_model(
    ...
    """Load a checkpoint by matching its key hash against the Wan registry."""
...
def load_wan22_ti2v_5b_components(
    ...
    """Load Wan2.2 TI2V components needed by FastWAM."""
