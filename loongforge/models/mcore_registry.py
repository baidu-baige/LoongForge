...
"""MCore model registry: model config, provider, and family lookups."""
...
def register_model_config(model_family: str, model_arch: str):
    """
    register new model config to loongforge.models.mcore_registry。
...
def register_model_provider(model_family: Union[str, List[str]]):
    """
    register model_provider func to loongforge.models.mcore_registry。
