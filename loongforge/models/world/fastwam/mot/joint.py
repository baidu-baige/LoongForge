...
"""Joint FastWAM variant with action-to-video attention."""
...
from loongforge.models.world.fastwam.mot.fastwam import FastWAM
...
class FastWAMJoint(FastWAM):
    ...
    def from_wan22_pretrained(cls, **kwargs):
        """Create a joint FastWAM model while validating video DiT config."""
    ...
    def infer_joint(
        ...
        """Run joint video-action inference while disabling redundant action-only testing."""
    ...
    def infer_action(
        ...
        """Infer only action tokens with the joint FastWAM denoising path."""
        self.eval()
