...
class PI05Policy(nn.Module):
    ...
    def predict_action(self, images, instructions, state=None, dataset_stats=None) -> np.ndarray:
        ...
        from loongforge.datasets.robotics.pi05.transforms.pi05_transform import StateDiscretizationTransform
        from loongforge.datasets.common.transforms.utils.builders import convert_stats
        from loongforge.datasets.common.transforms.utils.image_transform import ImageTransform
