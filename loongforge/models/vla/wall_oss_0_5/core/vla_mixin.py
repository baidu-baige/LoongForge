...
from loongforge.models.vla.wall_oss_0_5.core.action.moe import SparseMoeBlock, TokenTypeRouter
from loongforge.models.vla.wall_oss_0_5.core.action.processor import ActionProcessor
from loongforge.models.vla.wall_oss_0_5.core.attention.mask import (
    update_joint_attention_mask_2d,
    update_position_ids,
)
from loongforge.models.vla.wall_oss_0_5.constant import is_action_dataset_name
...
class ActionGenerationMixin(GenerationMixin):
    ...
    def to_bfloat16_for_selected_params(self, fsdp_plugin=None, accelerator=None):
        ...
        if fsdp_plugin:
            ...
            from loongforge.models.vla.wall_oss_0_5.qwen2_5.modeling_qwen2_5_vl_act import (
