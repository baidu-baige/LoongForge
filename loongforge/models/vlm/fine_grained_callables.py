...
from loongforge.models.vlm.utils import get_inputs_on_this_cp_rank
from loongforge.engine.mcore.initialize import mpu
    ...
    def forward_impl(self):
        ...
        if has_encoder_model:
            ...
            if model.add_encoder and mpu.is_pipeline_first_stage()  and self.enable_encoder_hetero_dp:
                ...
                from loongforge.engine.mcore.initialize import get_model_size
                if mpu.is_pipeline_first_stage():
                    ...
                    if _offload_mgr.enabled and local_rank == src_rank:
                        from loongforge.engine.mcore.full_hetero_cpu_offload import reload_list_item
                        reload_list_item(
