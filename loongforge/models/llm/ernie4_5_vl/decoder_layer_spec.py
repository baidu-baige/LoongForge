...
from loongforge.models.vision.ernie4_5_vl.adapter import RMSNorm as _AdapterRMSNorm
from loongforge.models.dispatch import multiacc_modules
from .transformer_layer import TransformerLayerErnie
from .config import ErnieMoeConfig
from .moe_layer import ErnieMultiTypeMoE, MultiTypeMoeSubmodules, ErnieMoeLayer
from .experts import ErnieMLP, SequentialMLP, ErnieSharedExpertMLP
from .pos_embedding import apply_rotary_3d
