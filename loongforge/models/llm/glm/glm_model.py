...
from loongforge.models.llm.base import BaseGPTModel
...
class GlmModelWithMTP(BaseGPTModel):
    """Glm Transformer language model with MTP module supported..
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if config.model_spec is None:
            model_spec = [
                "loongforge.models.llm.glm.glm_layer_spec",
                "get_glm_decoder_block_and_mtp_spec",
            ]
        else:
