...
from loongforge.models.vlm.utils import get_pos_emb_on_this_cp_rank
from loongforge.models.llm.qwen2.qwen_model import (
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if config.model_spec is None:
            model_spec = [
                "loongforge.models.llm.qwen3.qwen_layer_spec",
