...
# The script needs to be run on at least 16 nodes for 192k seqlength.
...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/workspace/LoongForge/mini_max/MiniMax_m2_7_mcore_tp8pp16ep8etp1/"}
