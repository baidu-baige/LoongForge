...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/rapidfs/models/MiniMax-M2.5-BF16/"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/rapidfs/LoongForge/mini_max/MiniMax_m2_5_mcore_tp8pp16ep8etp1/"}
CHECKPOINT_SAVE_PATH="/mnt/rapidfs/LoongForge/ckpt/minimax_m2_5/allmodel"
TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/rapidfs/LoongForge/tensorboard-log/minimax_m2_5/allmodel"}
