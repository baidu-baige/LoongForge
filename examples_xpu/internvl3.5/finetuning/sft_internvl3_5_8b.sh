...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/loongforge/sft_internvl3.5_8b_temp/hf-tokenizer-path/Internvl3_5-8B_20251231121543"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/workspace/loongforge/sft_internvl3.5_8b_temp/load/Internvl3_5-8B-tp4-pp1"}
CHECKPOINT_SAVE_PATH=/workspace/loongforge/sft_internvl3.5_8b_temp/save/Internvl3_5-8B-tp4-pp1-save
EXP_NAME=${FULL_JOB_NAME:-"${MODEL_NAME}-$(date +%Y%m%d-%H%M%S)"}
LOGS_PATH="${CHECKPOINT_SAVE_PATH}/logs-${EXP_NAME}"
TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/workspace/loongforge_ci/out/tensorboard/internvl3.5/internvl3.5-8b/stage2-16k-gbs32-1node-data3-v11/"}
