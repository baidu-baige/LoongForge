...
LOAD=/mnt/rapidfs/users/baige/zhaiyanfeng/models/internvl/InternVL3.5-1B
SAVE=/mnt/rapidfs/users/baige/zhaiyanfeng/out/ckpt_convert/internvl3.5-1b-tp-pp1
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --save_platform=mcore \
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/internvl3_5/internvl3.5-1b.json \
