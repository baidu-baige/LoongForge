...
SAVE=/mnt/cluster/BaigeOmni/internvl3.5/internvl3.5-38b-hf-Dec23
LOAD=/mnt/cluster/BaigeOmni/internvl3.5/internvl3.5-38b-tp4-pp2-Original/release
OMNI_LOAD=/mnt/cluster/BaigeOmni/internvl3.5/internvl3.5-38b-tp4-pp2-Dec15/release
...
MODEL_CONFIG_FILE=${OMNI_PATH}/configs/models/internvl3.5/internvl3_5_38b.yaml

FOUNDATION_CONVERT_FILE=${OMNI_PATH}/configs/models/qwen3/ckpt_convert/qwen3_convert_intern.yaml
