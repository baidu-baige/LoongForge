...
LOAD=/mnt/rapidfs/users/baige/zhaiyanfeng/out/ckpt_convert/InternVL3_5-14B-tp4-pp1-save/release
SAVE=/mnt/rapidfs/users/baige/zhaiyanfeng/models/internvl/test-mcore-to-hf/Internvl3_5-14B
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/internvl3_5/internvl3.5-14b.json \
