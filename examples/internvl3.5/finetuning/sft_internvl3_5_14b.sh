...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/cluster/models/InternVL3_5-14B/"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/models/internvl/ckpt-megatron/Internvl3_5-14B-tp4-pp1"}
