...
TOKENIZER_PATH=/mnt/cluster/huggingface.co/OpenGVLab/InternVL3_5-30B-A3B/
CHECKPOINT_LOAD_PATH=/mnt/cluster/zhaiyanfeng/models/internvl/ckpt-megatron/InternVL3_5-30B-A3B-tp4pp1ep8etp1
CHECKPOINT_SAVE_PATH=/mnt/cluster/zhaiyanfeng/models/internvl/ckpt-megatron/InternVL3_5-30B-A3B-tp4pp1ep8etp1-save
...
MODEL_ARGS=(
  --model-name internvl3.5-30b-a3b
