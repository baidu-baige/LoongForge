...
#   CONFIG=examples/vla/groot_n1_7/eval/configs/simplerenv/widowx_carrot_on_plate.yaml \
#   bash examples/vla/groot_n1_7/eval/run_simplerenv_eval.sh
#
...
# loongforge/evaluation/docs/patches/simplerenv/groot_n1_7.md.

set -euo pipefail

REPO_ROOT=${REPO_ROOT:-/workspace/LoongForge-VLA}
EXAMPLE_EVAL_ROOT=${EXAMPLE_EVAL_ROOT:-${REPO_ROOT}/examples/vla/groot_n1_7/eval}
...
${BENCHMARK_PYTHON:-/path/to/conda/envs/simplerenv/bin/python} -m loongforge.evaluation.orchestrator.run --config "${CONFIG}"
