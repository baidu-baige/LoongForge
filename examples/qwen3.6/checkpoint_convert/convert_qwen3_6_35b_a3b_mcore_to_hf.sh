...
SAVE=/workspace/Qwen3.6-35B-A3B-HF
LOAD=/workspace/qwen3.6-35b-a3b-tp1pp2ep4_tmp/release
OMNI_LOAD=/workspace/qwen3.6-35b-a3b-tp1pp2ep4/release
...
MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3.6/qwen3_6_35b_a3b.yaml

FOUNDATION_CONVERT_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3.6/ckpt_convert/qwen3_6_moe_convert.yaml
