...
MODEL_CONFIG_FILE=${LOONGFORGE_PATH}/configs/models/qwen3.6/qwen3_6_35b_a3b.yaml

FOUNDATION_CONVERT_FILE=${LOONGFORGE_PATH}/configs/models/qwen3.6/ckpt_convert/qwen3_6_moe_convert.yaml
