...
# ═══════════════════════════════════════════════════════════════
# run_dreamzero_wan22_5b_full_ddp_zero1_finetune.sh - DreamZero Wan2.2-5B Full FT (DDP + ZeRO1)
#
# DreamZero full fine-tuning with the Wan2.2-TI2V-5B backbone using
# 8-GPU DDP + ZeRO Stage-1 by default.
#
# Usage:
#   bash run_dreamzero_wan22_5b_full_ddp_zero1_finetune.sh
...
OUTPUT_DIR=${OUTPUT_DIR:-"$LOONGFORGE_PATH/outputs/dreamzero/droid_wan22_5b_full"}
...
# ── Launch ────────────────────────────────────────────────────
echo "════════════════════════════════════════════════════════════"
echo "  LoongForge DreamZero Wan2.2-5B Full Fine-Tuning (DDP + ZeRO1)"
