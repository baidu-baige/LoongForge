...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/LoongForge/qwen3.5-35b-a3b-tp1pp2ep4/"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/LoongForge/tensorboard-log/qwen3.5-35b-a3b-tp1pp2ep4"}
...
MODEL_CONFIG_PATH=${LOONGFORGE_PATH}/configs/models/qwen3.5/qwen3_5_35b_a3b.yaml
