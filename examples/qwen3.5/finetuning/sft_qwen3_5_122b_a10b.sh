...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/cluster/models/Qwen3.5-122B-A10B"}

CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/LoongForge/qwen3.5-122b-a10b-tp1pp4ep8/"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/LoongForge/tensorboard-log/qwen3.5-122b-a10b-tp1pp4ep8"}
...
MODEL_CONFIG_PATH=${LOONGFORGE_PATH}/configs/models/qwen3.5/qwen3_5_122b_a10b.yaml
