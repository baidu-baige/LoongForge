...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/cluster/models/Qwen3.5-27B"}

CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/LoongForge/qwen3.5-27b-tp2pp1/"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/LoongForge/tensorboard-log/qwen3.5-27b-tp2pp1"}
...
MODEL_CONFIG_PATH=${LOONGFORGE_PATH}/configs/models/qwen3.5/qwen3_5_27b.yaml
