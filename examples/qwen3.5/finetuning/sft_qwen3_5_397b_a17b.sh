...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/LoongForge/qwen3.5-397b-a17b-tp1pp4ep8/"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/LoongForge/tensorboard-log/qwen3.5-397b-a17b-tp1pp4ep8"}
...
MODEL_CONFIG_PATH=${LOONGFORGE_PATH}/configs/models/qwen3.5/qwen3_5_397b_a17b.yaml
