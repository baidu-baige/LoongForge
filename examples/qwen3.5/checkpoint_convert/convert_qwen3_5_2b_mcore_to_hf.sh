...
SAVE=/workspace/Qwen3.5-2B-HF
LOAD=/workspace/qwen3.5-2b-tp1pp1_tmp/release
OMNI_LOAD=/workspace/qwen3.5-2b-tp1pp1/release
...
MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3.5/qwen3_5_2b.yaml
