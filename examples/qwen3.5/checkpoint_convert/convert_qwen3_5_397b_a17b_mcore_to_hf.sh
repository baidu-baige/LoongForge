...
SAVE=/workspace/Qwen3.5-397B-A17B-HF
LOAD=/workspace/qwen3.5-397b-a17b-tp1pp4ep8_tmp/release
OMNI_LOAD=/workspace/qwen3.5-397b-a17b-tp1pp4ep8/release
...
MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3.5/qwen3_5_397b_a17b.yaml
