...
SAVE=/workspace/Qwen3.5-27B-HF
LOAD=/workspace/qwen3.5-27b-tp2pp1_tmp/release
OMNI_LOAD=/workspace/qwen3.5-27b-tp2pp1/release
...
MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3.5/qwen3_5_27b.yaml

FOUNDATION_CONVERT_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3.5/ckpt_convert/qwen3_5_dense_convert.yaml
