...
SAVE=/workspace/Qwen3.5-122B-A10B-HF
LOAD=/workspace/qwen3.5-122b-a10b-tp1pp4ep8_tmp/release
OMNI_LOAD=/workspace/qwen3.5-122b-a10b-tp1pp4ep8/release
...
MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3.5/qwen3_5_122b_a10b.yaml

FOUNDATION_CONVERT_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3.5/ckpt_convert/qwen3_5_moe_convert.yaml
IMAGE_ENCODER_CONVERT_FILE=${BAIGE_OMNI_PATH}/configs/models/image_encoder/ckpt_convert/qwen3_5_vit_convert.yaml
