...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/BaigeOmni/qwen3.5-9b-tp1pp1/"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/BaigeOmni/tensorboard-log/qwen3.5-9b-tp1pp1"}
...
MODEL_CONFIG_PATH=${BAIGE_OMNI_PATH}/configs/models/qwen3.5/qwen3_5_9b.yaml
