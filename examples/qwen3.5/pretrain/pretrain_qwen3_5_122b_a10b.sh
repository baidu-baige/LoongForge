...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/BaigeOmni/qwen3.5-122b-a10b-tp1pp4ep8/"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/BaigeOmni/tensorboard-log/qwen3.5-122b-a10b-tp1pp4ep8"}
...
MODEL_CONFIG_PATH=${BAIGE_OMNI_PATH}/configs/models/qwen3.5/qwen3_5_122b_a10b.yaml
