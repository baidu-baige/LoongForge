...
OUTPUT_DIR=${OUTPUT_DIR:-"/workspace/outputs/dreamzero/droid_wan22_5b_full"}
TENSORBOARD_DIR=${TENSORBOARD_DIR:-"/workspace/tensorboard-log/dreamzero/droid_wan22_5b_full"}
