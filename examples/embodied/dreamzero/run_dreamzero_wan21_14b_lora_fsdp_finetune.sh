...
# ═══════════════════════════════════════════════════════════════
# run_dreamzero_wan21_14b_lora_fsdp_finetune.sh - DreamZero Wan2.1-14B LoRA FT (FSDP)
#
# DreamZero LoRA fine-tuning with the Wan2.1-I2V-14B backbone using
# 8-GPU FSDP by default.
#
# Usage:
#   bash run_dreamzero_wan21_14b_lora_fsdp_finetune.sh
...
OUTPUT_DIR=${OUTPUT_DIR:-"$LOONGFORGE_PATH/outputs/dreamzero/$DEFAULT_RUN_NAME"}
...
# ── Launch ────────────────────────────────────────────────────
echo "════════════════════════════════════════════════════════════"
echo "  LoongForge DreamZero Wan2.1-14B LoRA Fine-Tuning (FSDP)"
