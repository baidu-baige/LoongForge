...
# ═══════════════════════════════════════════════════════════════
# run_dreamzero_wan22_5b_lora_fsdp_finetune.sh - DreamZero Wan2.2-5B LoRA FT (FSDP)
#
# DreamZero LoRA fine-tuning with the Wan2.2-TI2V-5B backbone using
# 8-GPU FSDP by default.
#
# Usage:
#   bash run_dreamzero_wan22_5b_lora_fsdp_finetune.sh
...
OUTPUT_DIR=${OUTPUT_DIR:-"$LOONGFORGE_PATH/outputs/dreamzero/droid_wan22_5b_lora"}
...
# ── Launch ────────────────────────────────────────────────────
echo "════════════════════════════════════════════════════════════"
echo "  LoongForge DreamZero Wan2.2-5B LoRA Fine-Tuning (FSDP)"
