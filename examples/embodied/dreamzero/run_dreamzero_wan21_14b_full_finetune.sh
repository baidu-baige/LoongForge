...
OUTPUT_DIR=${OUTPUT_DIR:-"/workspace/outputs/dreamzero/droid_wan21_14b_full"}
TENSORBOARD_DIR=${TENSORBOARD_DIR:-"/workspace/tensorboard-log/dreamzero/droid_wan21_14b_full"}
...
echo "========================================================================"
echo "  LoongForge DreamZero Wan2.1-14B Full Fine-Tuning"
