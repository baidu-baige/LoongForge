...
# ============================================================================
# run_lingbot_vla_v2.sh - lingbot_vla_v2 optimizer-state-shard Launch Script (Embodied)
#
# Replicated-compute optimizer-state-shard: compute parameters are fully replicated, optimizer
...
#
# Usage:
#   bash run_lingbot_vla_v2.sh                                  # GBS80 best config, 20 iters
#   bash run_lingbot_vla_v2.sh > run.log 2>&1                   # capture output (caller's choice)
#   MICRO_BS=16 bash run_lingbot_vla_v2.sh                      # GBS128, GA1
#   MICRO_BS=8 GRAD_ACCUM=2 bash run_lingbot_vla_v2.sh          # GBS128, GA2
#   bash run_lingbot_vla_v2.sh --train-iters 50000              # override a training flag
#   bash run_lingbot_vla_v2.sh model.gradient_checkpointing=true # override a YAML field
#
...
# -- Launch -------------------------------------------------------------------
echo "========================================================================"
echo "  LoongForge lingbot_vla_v2 Training (optimizer-state-shard)"
