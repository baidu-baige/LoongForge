...
#
# Internal one-click: X-VLA LIBERO task-success.
# Default (only shipped config): configs/libero/libero_weight_object_smoke_internal.yaml
...
CONFIG=${CONFIG:-${EXAMPLE_EVAL_ROOT}/configs/libero/libero_weight_object_smoke_internal.yaml}
if [[ "${CONFIG}" != /* ]]; then
