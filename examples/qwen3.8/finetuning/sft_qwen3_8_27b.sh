...
export LOONGFORGE_PATH=${LOONGFORGE_PATH:-"${REPO_ROOT}"}
...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/cluster/models/Qwen3.8-27B"}

CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/LoongForge/qwen3.8-27b-tp2pp1/"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/LoongForge/tensorboard-log/qwen3.8-27b-tp2pp1"}
...
MODEL_CONFIG_PATH=${LOONGFORGE_PATH}/configs/models/qwen3.8/qwen3_8_27b.yaml
