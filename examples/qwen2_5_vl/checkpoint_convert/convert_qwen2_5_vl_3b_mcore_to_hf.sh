...
SAVE=/mnt/cluster/aiak-training-llm/qwen2_5-vl/qwen2_5-vl-3b-hf
LOAD=/mnt/cluster/aiak-training-llm/qwen2_5-vl/qwen2_5-vl-3b-tp1-pp1/release/
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/qwen2_5-vl-3b/qwen2_5.json \
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --save_platform=huggingface \
    --megatron_path $AIAK_MAGATRON_PATH \
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/qwen2_5-vl-3b/vision-model.json \
    --tensor_model_parallel_size=$TP \
...
python $CONVERT_CHECKPOINT_PATH/custom/qwen2_vl/adapter.py \
    ...
    --save_platform=huggingface \
    --megatron_path $AIAK_MAGATRON_PATH \
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/qwen2_5-vl-3b/adapter.json \
    --tensor_model_parallel_size=$TP \
    --pipeline_model_parallel_size=$PP \
    --load_ckpt_path=$LOAD \
...
python $CONVERT_CHECKPOINT_PATH/custom/qwen2_vl/vision_patch.py \
    ...
    --tensor_model_parallel_size=$TP \
    --pipeline_model_parallel_size=$PP \
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/qwen2_5-vl-3b/vision-patch.json \
    --load_ckpt_path=$LOAD \
...
# BASE=/mnt/cluster/huggingface.co/Qwen/Qwen2_5-VL-3B-Instruct/
