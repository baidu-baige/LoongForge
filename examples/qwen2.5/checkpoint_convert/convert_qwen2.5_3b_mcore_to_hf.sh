...
LOAD=/mnt/cluster/BaigeOmni/qwen2.5/qwen2.5-3b-tp1-pp1-Dec24/release/
SAVE=/mnt/cluster/BaigeOmni/qwen2.5/qwen2.5-3b-hf-Dec24

MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen2.5/qwen2_5_3b.yaml
