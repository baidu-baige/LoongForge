...
LOAD=/mnt/cluster/BaigeOmni/qwen2.5/qwen2.5-7b-tp2-pp4-Dec21/release/
SAVE=/mnt/cluster/BaigeOmni/qwen2.5/qwen2.5-7b-hf-Dec24

MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen2.5/qwen2_5_7b.yaml
