...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/cluster/huggingface.co/Qwen/Qwen2.5-32B"}

CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/OmniTraining/qwen2.5/Qwen2.5_32B_mcore_tp2pp4"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/OmniTraining/tensorboard-log/qwen2.5-32b-sft"}
...
MODEL_ARGS=(
    --model-name qwen2.5-32b # qwen2.5 options: 0.5b, 1.5b, 3b, 7b, 14b, 32b, 72b
    --rotary-base 1000000
