...
#DATA_PATH=${DATA_PATH:-"/mnt/cluster/BaigeOmni/qwen2.5/sft_aplaca_zh_tokenized"}
...
TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/BaigeOmni/tensorboard-log/qwen2.5-1.5b-sft"}
