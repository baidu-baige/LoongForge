...
LOAD=/mnt/cluster/loongforge-ckpt/deepseek2/DeepSeek_V2_Lite_group_tp1pp1ep8/release
SAVE=/mnt/cluster/loongforge-ckpt/huggingface.co/deepseek-ai/DeepSeek-V2-Lite
