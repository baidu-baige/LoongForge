...
LOAD=/mnt/cluster/loongforge-ckpt/deepseek2/DeepSeek_V2_group_tp1pp16ep8/release
SAVE=/mnt/cluster/loongforge-ckpt/huggingface.co/deepseek-ai/DeepSeek-V2
