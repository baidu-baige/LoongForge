...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/aiak-training-llm/llama3/mcore_llama3_8b_tp1_pp1"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/aiak-training-llm/tensorboard-log/llama3-8b-sft"}
...
MODEL_ARGS=(
    --model-name llama3-8b # options: llama3-8b, llama3-70b
    --rotary-base 500000
)
