...
DATA_PATH=${DATA_PATH:-"/mnt/cluster/OmniTraining/llama3/pile_test/pile-llama_text_document"}
...
TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/OmniTraining/tensorboard-log/llama3-70b-pretrain"}
