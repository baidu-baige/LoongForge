...
DATA_PATH=${DATA_PATH:-"/mnt/cluster/BaigeOmni/llama3/pile_test/pile-llama_text_document"}
...
TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/BaigeOmni/tensorboard-log/llama3-70b-pretrain"}
