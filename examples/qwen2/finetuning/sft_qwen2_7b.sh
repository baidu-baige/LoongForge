...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/aiak-training-llm/qwen2/Qwen2_7B_mcore_tp1pp1"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/aiak-training-llm/tensorboard-log/qwen2-7b-sft"}
...
MODEL_ARGS=(
    --model-name qwen2-7b # qwen2 options: 0.5b, 1.5b, 7b, 72b
    --rotary-base 1000000
