...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/cluster/huggingface.co/Qwen/Qwen2-72B/"}

CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/aiak-training-llm/qwen2/Qwen2_72B_mcore_tp4pp8"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/aiak-training-llm/tensorboard-log/qwen2-72b-sft"}
...
MODEL_ARGS=(
    --model-name qwen2-72b # qwen2 options: 0.5b, 1.5b, 7b, 72b
    --rotary-base 1000000
