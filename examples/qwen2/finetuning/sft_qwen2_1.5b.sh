...
#DATA_PATH=${DATA_PATH:-"/mnt/cluster/BaigeOmni/qwen2/sft_aplaca_zh_tokenized"}

DATA_CACHE_PATH=${DATA_CACHE_PATH:-"/mnt/cluster/BaigeOmni/qwen2/sft_aplaca_zh_data_cache"}
...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/BaigeOmni/qwen2/Qwen2_1.5B_mcore_tp1pp1"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/BaigeOmni/tensorboard-log/qwen2-1.5b-sft"}
