...
SAVE=/mnt/cluster/aiak-omni-ckpt/deepseek3/DeepSeek-V3-bf16-tp8pp8ep32etp1/  # the converted checkpoint will be in MCore BF16 format
CACHE=/mnt/cluster/aiak-omni-ckpt/deepseek3/DeepSeek-V3-cache
