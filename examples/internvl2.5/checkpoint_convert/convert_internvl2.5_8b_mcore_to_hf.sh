...
SAVE=/mnt/cluster/BaigeOmni/internvl2.5/internvl2.5-8b-hf-Dec22
LOAD=/mnt/cluster/BaigeOmni/internvl2.5/internvl2.5-8b-tp4-pp2-vpp2-custom-Original/release
OMNI_LOAD=/mnt/cluster/BaigeOmni/internvl2.5/internvl2.5-8b-tp4-pp2-vpp2-custom-Dec18/release
...
MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/internvl2.5/internvl2_5_8b.yaml

FOUNDATION_CONVERT_FILE=${BAIGE_OMNI_PATH}/configs/models/internlm2.5/ckpt_convert/internlm2_5_convert.yaml
