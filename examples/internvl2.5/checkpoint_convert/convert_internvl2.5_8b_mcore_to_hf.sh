...
MODEL_CONFIG_FILE=${OMNI_PATH}/configs/models/internvl2.5/internvl2_5_8b.yaml

FOUNDATION_CONVERT_FILE=${OMNI_PATH}/configs/models/internlm2.5/ckpt_convert/internlm2_5_convert.yaml
