...
LOAD=/mnt/rapidfs/users/baige/zhaiyanfeng/out/ckpt_convert/internvl2.5-38b-tp4-pp2/release
SAVE=/mnt/rapidfs/users/baige/zhaiyanfeng/models/internvl/test-mcore-to-hf/internvl2.5-38b
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/internvl2_5/internvl2.5-38b.json \
