...
SAVE=/mnt/cluster/aiak-training-llm/internvl2.5/internvl2.5-38b-hf-Dec23
LOAD=/mnt/cluster/aiak-training-llm/internvl2.5/internvl2.5-38b-tp4-pp2-custom-Original/release
OMNI_LOAD=/mnt/cluster/aiak-training-llm/internvl2.5/internvl2.5-38b-tp4-pp2-custom-Dec19/release
...
MODEL_CONFIG_FILE=${AIAK_TRAINING_PATH}/configs/models/internvl2.5/internvl2_5_38b.yaml

FOUNDATION_CONVERT_FILE=${AIAK_TRAINING_PATH}/configs/models/qwen2.5/ckpt_convert/qwen2_5_convert_intern.yaml
IMAGE_ENCODER_CONVERT_FILE=${AIAK_TRAINING_PATH}/configs/models/image_encoder/ckpt_convert/internvl_vit_6b_convert.yaml
