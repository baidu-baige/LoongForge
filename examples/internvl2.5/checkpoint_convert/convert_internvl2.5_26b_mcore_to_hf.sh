...
LOAD=/mnt/rapidfs/users/baige/zhaiyanfeng/out/ckpt_convert/internvl2.5-26b-tp4-pp2-2-46/release
SAVE=/mnt/rapidfs/users/baige/zhaiyanfeng/models/internvl/test-mcore-to-hf/internvl2.5-26b
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/internvl2_5/internvl2.5-26b.json \
    --tensor_model_parallel_size=$TP \
    --pipeline_model_parallel_size=$PP \
    --custom_pipeline_layers 2,46 \
    --load_ckpt_path=$LOAD \
