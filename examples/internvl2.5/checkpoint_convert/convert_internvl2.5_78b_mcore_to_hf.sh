...
LOAD=/mnt/rapidfs/users/baige/zhaiyanfeng/out/ckpt_convert/internvl2.5-78b-tp8-pp4/release
SAVE=/mnt/rapidfs/users/baige/zhaiyanfeng/models/internvl/test-mcore-to-hf/internvl2.5-78b
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/internvl2_5/internvl2.5-78b.json \
    --tensor_model_parallel_size=$TP \
    --pipeline_model_parallel_size=$PP \
    --custom_pipeline_layers 2,20,20,18 \
    --load_ckpt_path=$LOAD \
...
python $CONVERT_CHECKPOINT_PATH/model.py \
    ...
    --save_platform=huggingface \
    --megatron_path $AIAK_MEGATRON_PATH \
    --common_config_path=$CONVERT_CHECKPOINT_PATH/config/internvl2_5/vision-model-6b.json \
    --tensor_model_parallel_size=$TP \
