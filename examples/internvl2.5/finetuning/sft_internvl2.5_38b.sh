...
TOKENIZER_PATH=/mnt/cluster/zhaiyanfeng/models/internvl/ckpt/InternVL2_5-38B/
CHECKPOINT_LOAD_PATH=/mnt/cluster/zhaiyanfeng/models/internvl/ckpt-megatron/internvl2.5-38b-tp4-pp2-6-58
CHECKPOINT_SAVE_PATH=/mnt/cluster/zhaiyanfeng/models/internvl/ckpt-megatron/internvl2.5-38b-tp4-pp2-save
MEGATRON_PATH=${MEGATRON_PATH:-"/workspace/AIAK-Megatron/"}
AIAK_TRAINING_PATH=${AIAK_TRAINING_PATH:-"/workspace/AIAK-Training-Omni"}
TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/zhaiyanfeng/out/tensorboard/internvl2.5-master/38b-stage2-16k-1node-gbs32/"}
...
MODEL_ARGS=(
  --model-name internvl2.5-38b
  --rotary-base 1000000  # for qianfanvl
)
