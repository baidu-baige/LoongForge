...
TOKENIZER_PATH=/mnt/cluster/zhaiyanfeng/models/internvl/ckpt/InternVL2_5-8B/
CHECKPOINT_LOAD_PATH=/mnt/cluster/zhaiyanfeng/models/internvl/ckpt-megatron/internvl2.5-8b-tp4-pp1
CHECKPOINT_SAVE_PATH=/mnt/cluster/zhaiyanfeng/models/internvl/ckpt-megatron/internvl2.5-8b-tp4-pp1-save
MEGATRON_PATH=${MEGATRON_PATH:-"/workspace/AIAK-Megatron/"}
AIAK_TRAINING_PATH=${AIAK_TRAINING_PATH:-"/workspace/AIAK-Training-Omni"}
TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/zhaiyanfeng/out/tensorboard/internvl2.5-master/8b-stage2-16k-1node-gbs32-gelu/"}
