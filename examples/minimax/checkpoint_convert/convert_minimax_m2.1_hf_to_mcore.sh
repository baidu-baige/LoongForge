...
LOAD=/mnt/cluster/BaigeOmni/mini_max/MiniMax-M2.1/
SAVE=/mnt/cluster/BaigeOmni/mini_max/MiniMax_mcore_tp8pp4ep8etp1/

MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/minimax/minimax_m2_1.yaml
