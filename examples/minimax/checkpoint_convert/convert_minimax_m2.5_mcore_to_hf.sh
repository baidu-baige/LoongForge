...
LOAD=/mnt/cluster/OmniTraining/mini_max/MiniMax_mcore_tp8pp4ep8etp1/release
SAVE=/mnt/cluster/OmniTraining/mini_max/MiniMax-M2.5-hf/

MODEL_CONFIG_FILE=${AIAK_TRAINING_PATH}/configs/models/minimax/minimax_m2_5.yaml
