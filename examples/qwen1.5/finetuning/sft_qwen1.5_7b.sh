...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/aiak-training-llm/qwen1.5/Qwen1.5_7B_mcore_tp1pp1"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/aiak-training-llm/tensorboard-log/qwen1.5-7b-sft"}
...
MODEL_ARGS=(
    --model-name qwen1.5-7b # qwen1.5 options: 0.5b, 1.8b, 4b, 7b, 14b, 32b, 72b
    --rotary-base 1000000
