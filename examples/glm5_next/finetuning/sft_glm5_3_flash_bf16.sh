...
# This script is used for SFT training GLM-5.3-Flash in BF16 mixed precision.
...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/LoongForge/GLM/GLM-5.3-Flash-bf16-tp8pp5ep8etp1"}
CHECKPOINT_PATH_SAVE=${CHECKPOINT_PATH_SAVE:-"/mnt/cluster/LoongForge/GLM/save/GLM-5.3-Flash-bf16-tp8pp5ep8etp1"}
