...
LOAD=/mnt/cluster/baige-omni-ckpt/qwen/Qwen_7B_mcore_tp1pp1_omni/release
SAVE=/mnt/cluster/baige-omni-ckpt/huggingface.co/Qwen/Qwen-7B/

MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen/qwen_7b.yaml
