...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/OmniTraining/qwen/Qwen_7B_mcore_tp1pp1"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/OmniTraining/tensorboard-log/qwen-7b-sft"}
...
MODEL_ARGS=(
    --model-name qwen-7b # qwen1 options: qwen-1.8b, qwen-7b, qwen-14b, qwen-72b
)
