...
TOKENIZER_PATH=${TOKENIZER_PATH:-"/mnt/cluster/huggingface.co/Qwen/Qwen-72B/"}

CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/OmniTraining/qwen/Qwen_72B_mcore_tp2pp8"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/OmniTraining/tensorboard-log/qwen-72b-sft"}
...
MODEL_ARGS=(
    --model-name qwen-72b # qwen1 options: qwen-1.8b, qwen-7b, qwen-14b, qwen-72b
)
