...
#DATA_PATH=${DATA_PATH:-"/mnt/cluster/BaigeOmni/llama3.1/sft_aplaca_zh_tokenized"}

DATA_CACHE_PATH=${DATA_CACHE_PATH:-"/mnt/cluster/BaigeOmni/llama3.1/sft_aplaca_zh_data_cache"}
...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/BaigeOmni/llama3.1/mcore_llama3.1_405b_tp8_pp16"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/BaigeOmni/tensorboard-log/llama3.1-405b-tp8pp16"}
