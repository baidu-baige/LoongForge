...
LOAD=/mnt/cluster/loongforge-ckpt/llama3.1/mcore_llama3.1_8b_tp1_pp1_omni/release
SAVE=/mnt/cluster/loongforge-ckpt/huggingface.co/meta-llama/Meta-Llama-3.1-8B
