...
DATA_CACHE_PATH=${DATA_CACHE_PATH:-"/mnt/cluster/aiak-training-llm/qwen3_next/sft_aplaca_zh_data_cache"}
...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/aiak-training-llm/qwen3_next/Qwen3_Next_80B_A3B_mcore_tp1pp2ep8"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/aiak-training-llm/tensorboard-log/qwen3-next-80b-a3b"}
