...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/OmniTraining/qwen2_5-vl/qwen2_5-vl-32b-tp2-pp4"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/OmniTraining/tensorboard-log/qwen2_5-vl-32b"}
...
MODEL_CONFIG_PATH=${AIAK_TRAINING_PATH}/configs/models/qwen2.5vl/qwen2_5_vl_32b.yaml
