...
LOAD=/mnt/cluster/BaigeOmni/qwen3/qwen3-14b-tp2-pp4-Dec15/release/
SAVE=/mnt/cluster/BaigeOmni/qwen3/qwen3-14b-hf-Dec24

MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3/qwen3_14b.yaml
