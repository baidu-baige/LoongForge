...
LOAD=/mnt/cluster/BaigeOmni/qwen3/qwen3-4b-tp1-pp1-Dec24/release/
SAVE=/mnt/cluster/BaigeOmni/qwen3/qwen3-4b-hf-Dec24

MODEL_CONFIG_FILE=${BAIGE_OMNI_PATH}/configs/models/qwen3/qwen3_4b.yaml
