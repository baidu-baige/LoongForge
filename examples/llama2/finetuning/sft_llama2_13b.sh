...
#DATA_PATH=${DATA_PATH:-"/mnt/cluster/BaigeOmni/llama2/sft_aplaca_zh_tokenized"}

DATA_CACHE_PATH=${DATA_CACHE_PATH:-"/mnt/cluster/BaigeOmni/llama2/sft_aplaca_zh_data_cache"}
...
TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/BaigeOmni/tensorboard-log/llama2-13b-sft"}
