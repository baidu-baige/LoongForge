...
LOAD=/mnt/cluster/loongforge-ckpt/llama2/mcore_llama2_70b_tp4_pp4_omni/release
SAVE=/mnt/cluster/loongforge-ckpt/huggingface.co/meta-llama/Llama-2-70b-hf/
