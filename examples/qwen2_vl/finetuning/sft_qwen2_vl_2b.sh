...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/mnt/cluster/aiak-training-llm/qwen2-vl/qwen2-vl-2b-tp1-pp1"}

TENSORBOARD_PATH=${TENSORBOARD_PATH:-"/mnt/cluster/aiak-training-llm/tensorboard-log/qwen2-vl-2b"}
...
# or you can setup qwen2-vl-2b by using the following command
MODEL_ARGS=(
