...
def _add_log_tensor_args(parser):
    ...
    group.add_argument('--enable-log-tensor', action='store_true',
                          help='trace debug info & tensors.')
    # default value means log all module's info
    group.add_argument('--log-tensor-name-pattern', type=str, default=None,
                       help='The module name pattern by which log tensor is applied')
    group.add_argument('--log-tensor-stage', type=str, default="forward",
                       choices=['init', 'forward', 'backward'],
                       help='log tensor at which stage')
    group.add_argument('--log-tensor-iter-pattern', type=str, default=None,
                       help='for which iters to log tensors, value like 8,15,20')
    group.add_argument('--log-tensor-mbs-pattern', type=str, default=None,
                       help='for which mbs to log tensors, value like 8,15,20')
    group.add_argument('--log-tensor-layer-pattern', type=str, default=None,
                       help='for which layer to log tensors, value like 8,15,20')
    group.add_argument('--log-tensor-rank', type=str, default='0',
...
def _add_extra_video_args(parser):
    ...
    group.add_argument('--max-video-length', type=int, default=32760,
                       help='Maximum video length')

    group.add_argument('--max-image-length', type=int,
                       help='Maximum image length')

    group.add_argument('--max-timestep-boundary', type=float, default=1,
                       help='The maximum timestep boundary for dit, with a value range between 0 and 1.')

    group.add_argument('--min-timestep-boundary', type=float, default=0,
    ...
    group.add_argument('--min-num-frame', type=int, default=8,
                       help='The minimum number of frames for video data. Default is 8.')

    group.add_argument('--max-num-frame', type=int, default=32,
                       help='The maximum number of frames for video data. Default is 32.')

    group.add_argument('--dynamic-image-size', action='store_true',
                       help='Set to True to use dynamic high resolution strategy. Default is False.')

    group.add_argument('--min-dynamic-patch', type=int, default=1,
                       help='The minimum number of dynamic patches. Default is 1.')

    group.add_argument('--max-dynamic-patch', type=int, default=12,
                       help='The maximum number of dynamic patches. Default is 12.')

    group.add_argument('--use_thumbnail', action='store_true',
                       help='Set to True to add a thumbnail image. Default is False.')

    group.add_argument('--normalize_type', type=str, default='imagenet',
    ...
    group.add_argument('--dataloader-prefetch-factor', type=int, default=2,
