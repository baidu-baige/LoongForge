...
from aiak_training_omni.models.baichuan.layers import ColumnParallelLinear as BaichuanColumnParallelLinear


class BaichuanModel(LanguageModule):
    """Baichuan Transformer language model.
    ...
    def __init__(
        ...
        if post_process:
            ...
            # Using a custom ColumnLinear with NormHead support,
            # gradient_accumulation_fusion will be ignored here even when enabled,
            # yet it still remains effective in other layers.
            self.output_layer = BaichuanColumnParallelLinear(
                config.hidden_size,
                self.vocab_size,
                config=config,
    ...
    def forward(
        ...
        """Forward function of the Baichuan Model This function passes the input tensors
