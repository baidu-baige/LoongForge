...
def _load_state_dict_hook_ignore_extra_state(module, incompatible_keys):
    """Hook to ignore Transformer Engine _extra_state.
    ...
    keys_to_remove = [
        ...
        if "pre_mlp_layernorm._extra_state" in key
...
class MixtralModel(LanguageModule):
    """Mixtral Transformer language model.

    Args:
        config (TransformerConfigAiak): Transformer config
