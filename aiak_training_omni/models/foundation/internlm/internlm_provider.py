...
from .internlm_layer_spec import get_internlm_layer_with_te_spec


@register_model_provider(model_family=[LanguageModelFamilies.INTERNLM2_5])
def internlm_model_provider(
    pre_process: bool = True,
    post_process: bool = True,
    parallel_output: bool = True,
) -> InternLMModel:
    """Builds the internlm model.
    ...
    if args.spec is not None:
        ...
        transformer_layer_spec = get_internlm_layer_with_te_spec(config)
