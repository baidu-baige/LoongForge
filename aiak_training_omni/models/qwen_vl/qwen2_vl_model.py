...
from .utils import get_pos_emb_on_this_cp_rank_by_tex, get_inputs_on_this_cp_rank_by_tex
    ...
    def forward(
        ...
        if self.pre_process:
            ...
            if self.config.context_parallel_size > 1:
                combined_embeddings = get_inputs_on_this_cp_rank_by_tex(combined_embeddings, packed_seq_params)
