...
from aiak_training_omni.models.llavaov_1_5.rice_vision_model import (
    RiceViTModel, VisionModel)
from aiak_training_omni.models.qwen import QwenModel
from aiak_training_omni.models.qwen_vl.adapter import Adapter
from aiak_training_omni.models.qwen_vl.utils import get_inputs_on_this_cp_rank
...
class LlavaOnevision15(MegatronModule):
    """
    Args:
    ...
    def forward(
        ...
        if use_inference_kv_cache:
            ...
            if pixel_values_videos is not None:
                ...
                # # If running inference, the language model KV cache will be updated for image token positions.
                # # Here we store the image tokens sequence length, 
                # # which can be used as an offset to the KV cache later.
                # if inference_params is not None:
