...
class TransformerLayerSchedulePlan:
    ...
    * mtp.mtp_post_process contains output_layer, mtp loss operations, whereas
    ...
    def run(
        ...
        comm_stream: combine_bwd                                 | dispatch_fwd | dispatch_bwd |
        comp_stream: post_combine_bwd → attn_fwd → post_attn_fwd | mlp_bwd      | mlp_fwd      |
        
        comm_stream: combine_fwd                                         | PP_fwd     | PP_bwd        |
        comp_stream: mlp_bwd_dw → post_attn_bwd → post_combine_fwd       | attn_bwd   | attn_bwd_dw   |
