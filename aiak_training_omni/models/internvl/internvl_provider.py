...
def internvl_model_provider(
    ...
    print_rank_0(f'building InternVL model: {args.model_name}')
    ...
    for k, v in asdict(get_vision_config[args.model_name]()).items():
        setattr(vision_config, k, v)

    for k, v in asdict(get_adapeter_config[args.model_name]()).items():
    ...
    if args.spec is not None:
        ...
        language_layer_spec = get_language_layer_with_te_spec(args.model_name, language_config)
