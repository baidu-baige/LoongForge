...
from aiak_training_omni.models.internlm import InternLMModel, DynamicRotaryEmbedding
...
class InternVLModel(MegatronModule):
    ...
    def __init__(self,
        ...
        if self.add_decoder:
            if args.model_name in ['internvl2.5-8b', 'internvl2.5-26b']:
                ...
                if args.model_name in ['internvl3-8b', 'internvl3-14b', 'internvl3-38b', 'internvl3-78b']:
