...
def get_batch_on_this_tp_rank(data_iterator):
    ...
    if mpu.get_tensor_model_parallel_rank() == 0:
        ...
        images = torch.empty(args.micro_batch_size, 3, args.img_h, args.img_w,
                            dtype=args.params_dtype, device=torch.cuda.current_device())
        input_ids = torch.empty((args.micro_batch_size, args.seq_length),
        ...
        token_type_ids = torch.empty(args.micro_batch_size, args.seq_length,
                            dtype=torch.int64, device=torch.cuda.current_device())
        attention_mask = torch.empty(args.micro_batch_size, 1, 1, args.seq_length,
