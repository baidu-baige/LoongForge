...
# from aiak_training_omni.models.internvl.qwen.qwen_config import qwen2_5_72b, qwen2_5_32b, qwen2_5_7b, qwen2_5_14b, \
...
get_vision_config = {
    ...
    ## todo: remove this after merge new omni model
    "intern_vl": get_vision_config_for_300m,
}
...
get_adapeter_config = {
    ...
    ## todo: remove this after merge the new model
    "intern_vl": get_adapeter_config_for_internvl3_5_8b,
}
