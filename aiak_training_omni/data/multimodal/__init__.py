...
TASK_ENCODER_REGISTRY = {
    "vlmtaskencoder": "aiak_training_omni.data.multimodal.vlm_task_encoder.VLMTaskEncoder",
    "internvltaskencoder": "aiak_training_omni.data.multimodal.internvl.internvl_task_encoder.InternVLTaskEncoder",
    "llavaov15taskencoder": "aiak_training_omni.data.multimodal.llava_ov_task_encoder.LLavaOv15TaskEncoder",
}
