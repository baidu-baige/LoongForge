...
from omni_training.models.utils import build_model_config
from omni_training.train.arguments import aiak_extra_train_args_provider
from omni_training.train.get_loss_func import (default_loss_func,
                                                    loss_func_internvl)
from omni_training.train.get_position_idx_func import (get_mrope_index, 
                                                            get_position_ids, 
                                                            get_rope_index_internvl, 
                                                            get_rope_index_qwen3vl)
from omni_training.train.validators import (validate_aiak_extra_args,
                                                validate_custom_model_args,
                                                validate_megatron_args)
from omni_training.utils import constants
from omni_training.utils.config_map import get_config_from_model_name
from omni_training.utils.global_vars import (get_hydra_config,
                                                  set_args_dict,
                                                  set_data_config,
                                                  set_hydra_config,
                                                  set_model_config)
from omni_training.utils.utils import get_config_from_file
...
def parse_arguments(
    ...
    if model_type in constants.VisionLanguageModelFamilies.names():
        ...
        for name, config_values in model_config.items():
            ...
            assert args_deepcopy.yaml_cfg is None, "yaml_cfg is not supported in OmniTraining yet"
        ...
        assert args.yaml_cfg is None, "yaml_cfg is not supported in OmniTraining yet"
