...
from omni_training.tokenizer import get_default_tokenizer
from omni_training.utils import (constants, get_device_arch_version,
                                      is_torch_min_version, print_rank_0, convert_custom_pipeline_to_layout)
from omni_training.utils.utils import get_default_sft_dataset_config, get_transformers_version
...
def _validate_custom_model_args(name, args, defaults={}):
    ...
    # # add aiak for custom virtual layers in first pipeline stage check
