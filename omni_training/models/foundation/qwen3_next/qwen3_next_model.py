...
from omni_training.models.foundation.qwen3_next.qwen3_next_config import Qwen3NextConfig
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if config.model_spec is None:
            model_spec = [
                "omni_training.models.foundation.qwen3_next.qwen3_next_layer_spec",
                "get_qwen3_next_transformer_layer_spec",
            ]
        else:
