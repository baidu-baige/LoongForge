...
from omni_training.models.encoder.base_vision_models.base_vision_model import (
    BaseVisionModel,
)
...
class RiceViTModel(BaseVisionModel):
    ...
    def __init__(
        ...
        if config.model_spec is None:
            config.model_spec = [
                "omni_training.models.encoder.llavaov1_5_vision_models.llavaov_1_5_layer_spec",
