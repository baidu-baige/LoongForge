...
from omni_training.models.omni_models.utils import get_inputs_on_this_cp_rank
...
class PostProcessNode(ScheduleNode):
    ...
    def forward_impl(self, hidden_states):
        ...
        if self.gpt_model.decoder.final_layernorm and not getattr(self.gpt_model, 'mtp_process', False):
