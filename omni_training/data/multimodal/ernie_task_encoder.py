...
from omni_training.data.multimodal import MultiMixQASample
from omni_training.data.multimodal.base.task_encoder import (
    BaseTaskEncoder,
    BaseTaskSample,
...
from omni_training.data.multimodal.ernie.tokenizer_vl import (
    Ernie45VLTokenizer,
    special_tokens_info as ERNIE_SPECIAL_TOKENS_INFO,
)
from omni_training.data.multimodal.ernie.chat_template_utils import (
    apply_chat_training_template,
)
from omni_training.data.multimodal.ernie.example_to_feature import (
    ExampleToFeature,
)
from omni_training.data.multimodal.ernie.image_preprocessor import (
    AdaptiveImageProcessor,
)
from omni_training.data.multimodal.ernie.image_modification import (
...
class ErnieTaskEncoder(BaseTaskEncoder):
    ...
    def encode_multi_mix_qa(self, sample: MultiMixQASample) -> ErnieTaskSample:
        ...
        if images and len(image_meta) > 0:
            from omni_training.data.multimodal.ernie.image_modification import VisionExample
