...
def dataloader_adaptation():
    ...
    from omni_training.data.dp_balance.wrapper.dp_balance.dataloader_wrapper import (
        pin_memory_loop_wrapper,
    )
    from omni_training.data.dp_balance.wrapper.dp_balance.rerun_state_wrapper import (
        RerunDataIterator,
    )
    from omni_training.data.dp_balance.wrapper.dp_balance.energon_dataloader_wrapper import (
        SavableDataLoader,
        BasicDataLoader,
    )
    ...
    register_patch(
        "omni_training.data.dp_balance.dataloader._utils.pin_memory.pin_memory_loop",
        pin_memory_loop_wrapper,
    )
