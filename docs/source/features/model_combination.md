...
One of the core features of the **BaigeOmni** framework is **native support for flexible network assembly**.  
...
```python
# baige_omni/models/omni_models/omni_encoder_model.py
...
```python
# baige_omni/models/omni_models/omni_combination_model.py
...
```python
# baige_omni/models/omni_models/omni_model_provider.py
...
model:
  ...
  foundation:
    ...
    model_spec: ["baige_omni.models.foundation.internlm.internlm_layer_spec",
