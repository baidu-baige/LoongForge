...
AIAK-Training-Omni provides FP8 low-precision training for various models. By editing the corresponding YAML config files you can turn FP8 on/off independently for the vision/audio **Encoder** and the language **Foundation** model, achieving the best training efficiency.
...
model:
  ...
  foundation:
    ...
    rotary_base: 1000000
    model_spec: ["aiak_training_omni.models.foundation.qwen3.qwen_layer_spec",
    ...
    fp8_param: True
  image_encoder:
    model_spec: ["aiak_training_omni.models.encoder.qwen3_vl_vision_models.qwen3_vl_layer_spec",
