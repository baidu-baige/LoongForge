...
This document describes how to add copyright and license headers in OmniTraining. The OmniTraining repository is released under the [Apache License 2.0](https://github.com/baidu-baige/OmniTraining/blob/master/LICENSE).
...
- Original files written for OmniTraining should use a short SPDX-based Apache-2.0 header.
...
## Case 1: Original Files Written for OmniTraining

For new source files authored by the OmniTraining team or contributors, use the short SPDX-based Apache-2.0 header. This keeps files concise while remaining clear, machine-readable, and consistent with modern tooling.
...
**The Golden Rule:** Do not alter the upstream author's original header. Prepend the OmniTraining copyright, an SPDX identifier, a single line stating the origin and license, and then paste the upstream header *exactly as it is* (whether it is 1 line or 20 lines).
...
2. **Is it modified from a third party?** Use the Universal Template (Case 2): add our 3-line OmniTraining header + origin statement, then copy-paste the original author's header verbatim below it.