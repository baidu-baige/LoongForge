...
Based on supporting open-source Megatron parameters, LoongForge adds more convenient training startup parameters. Detailed configuration can be found in the loongforge/engine/mcore/arguments.py file. Main parameter descriptions are as follows:
