...
This document records the benchmark runtime environments used by the LoongForge-VLA eval module under `loongforge/evaluation`.
...
```text
examples/vla/pi05/eval/configs/libero/*.yaml
```
...
X-VLA WidowX status:   task success after absolute EE controller patch
                       ...
                       configs: examples/vla/xvla/eval/configs/simplerenv/*
GR00T-N1.6 status:     task success (open_drawer 10/10, close_drawer 9/10,
                       ...
                       configs: examples/vla/groot_n1_6/eval/configs/simplerenv/*
...
```text
examples/vla/pi05/eval/configs/simplerenv/*.yaml
examples/vla/xvla/eval/configs/simplerenv/*.yaml
```
...
pi05 RoboTwin2:        task success (adjust_bottle demo_clean)
                       ...
                       stats: examples/vla/pi05/eval/assets/pi05_robotwin2_dataset_stats.json
...
```text
examples/vla/pi05/eval/configs/robotwin/*.yaml
examples/vla/xvla/eval/configs/robotwin/*.yaml
```
...
```text
examples/vla/pi05/eval/configs/maniskill/*.yaml
```
