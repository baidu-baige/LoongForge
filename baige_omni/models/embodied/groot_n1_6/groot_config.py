"""Register Gr00tN1d6 config with the model factory."""

from baige_omni.models.factory import register_model_config
from baige_omni.utils.constants import VisionLanguageActionModelFamilies

from .configuration_groot import Gr00tN1d6OmniConfig


@register_model_config(
    model_family=VisionLanguageActionModelFamilies.GROOT_N1_6,
    model_arch=VisionLanguageActionModelFamilies.GROOT_N1_6,
)
def groot_n1_6_config():
    """Return a default Gr00tN1d6 config instance."""
    cfg = Gr00tN1d6OmniConfig()
