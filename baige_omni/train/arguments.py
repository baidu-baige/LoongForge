...
"""BaigeOmni Training Arguments Module

This module defines command-line arguments for BaigeOmni training pipeline,
...
from baige_omni.data import get_support_templates
from baige_omni.models import get_support_model_archs
from baige_omni.utils import constants


def baige_extra_train_args_provider(parser: argparse.ArgumentParser):
    """Add Baige-specific arguments to the argument parser.
    
    This function serves as the main entry point for adding all Baige-specific
    ...
    Returns:
        The modified argument parser with all Baige arguments added.
    """
...
def _add_extra_tokenizer_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        ...
        help="Tokenizer implementation to use. "
             ...
             "When None, Baige automatically determines the appropriate tokenizer. "
             "Default: None"
    )
