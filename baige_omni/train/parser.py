...
from baige_omni.models.utils import build_model_config
from baige_omni.train.arguments import baige_extra_train_args_provider
from baige_omni.train.get_loss_func import (default_loss_func,
                                                    loss_func_internvl)
from baige_omni.train.get_position_idx_func import (get_mrope_index, 
                                                            get_position_ids, 
                                                            get_rope_index_internvl, 
                                                            get_rope_index_qwen3vl)
from baige_omni.train.validators import (validate_baige_extra_args,
...
from baige_omni.utils.global_vars import (get_hydra_config,
                                                  set_args_dict,
                                                  set_data_config,
                                                  set_hydra_config,
                                                  set_model_config)
from baige_omni.utils.utils import get_config_from_file
...
def parse_arguments(
    ...
    if model_type in constants.VisionLanguageModelFamilies.names():
        ...
        for name, config_values in model_config.items():
            ...
            assert args_deepcopy.yaml_cfg is None, "yaml_cfg is not supported in BaigeOmni yet"
        ...
        assert args.yaml_cfg is None, "yaml_cfg is not supported in BaigeOmni yet"
...
def parse_train_args(args_defaults={}):
    ...
    args, hydra_cfg = parse_arguments(
        extra_args_provider=baige_extra_train_args_provider,
        validate_extra_args_provider=validate_baige_extra_args,
