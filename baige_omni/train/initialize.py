...
from baige_omni.utils.global_vars import set_baige_extra_global_vars
...
def initialize_baige_megatron(
    ...
    # set baige extra global args
    set_baige_extra_global_vars(args, build_tokenizer=True)
