...
from baige_omni.utils import get_args, print_rank_0
from baige_omni.utils.constants import TrainingPhase, VisionLanguageModelFamilies
from baige_omni.data.multimodal.ernie.data_utils import ErnieTensorDataset
...
from baige_omni.models.omni_models.omni_model_provider import (
    omni_model_provider
)
...
def train_valid_test_datasets_provider_energon(train_val_test_num_samples):
    ...
    """
    from baige_omni.data.multimodal import build_task_encoder
    from baige_omni.data.multimodal.dataloader_provider import (
        get_train_dataset,
        get_train_loader,
    )
