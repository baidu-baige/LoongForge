...
from baige_omni.models import get_model_family, get_model_provider
from baige_omni.train.megatron_trainer import MegatronTrainer
from baige_omni.train.sft.utils import _build_cylic_iterator, _cyclic_iter
from baige_omni.train.trainer_builder import register_model_trainer
from baige_omni.utils import constants, get_args, print_rank_0
from baige_omni.utils.global_vars import get_model_config
from baige_omni.models.embodied.groot_n1_6.configuration_groot import (
...
def train_valid_test_datasets_provider(train_val_test_num_samples):
    ...
    try:
        from baige_omni.models.embodied.groot_n1_6.processor_groot import (
            make_gr00t_n1d6_pre_post_processors,
        )
        from baige_omni.models.embodied.groot_n1_6.utils import EMBODIMENT_STAT_CONFIGS
