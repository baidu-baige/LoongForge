...
from baige_omni.tokenizer import get_default_tokenizer
from baige_omni.utils import (constants, get_device_arch_version,
                                      is_torch_min_version, print_rank_0, convert_custom_pipeline_to_layout)
from baige_omni.utils.utils import get_default_sft_dataset_config, get_transformers_version


def validate_baige_extra_args(args, config):
    """ "Validate Baige extra arguments"""
    ...
    # megatron one_logger is not supported in baige
...
def _validate_legacy_pipeline_args(args):
    ...
    # add baige for custom virtual pipeline layers check
...
def _validate_custom_model_args(name, args, defaults={}):
    ...
    # Temporary model parallel size. Added by baige
