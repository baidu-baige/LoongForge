...
from baige_omni.data.multimodal import MultiMixQASample
from baige_omni.data.multimodal.base.task_encoder import (
    BaseTaskEncoder,
    BaseTaskSample,
...
from baige_omni.data.multimodal.ernie.tokenizer_vl import (
    Ernie45VLTokenizer,
    special_tokens_info as ERNIE_SPECIAL_TOKENS_INFO,
)
from baige_omni.data.multimodal.ernie.chat_template_utils import (
    apply_chat_training_template,
)
from baige_omni.data.multimodal.ernie.example_to_feature import (
    ExampleToFeature,
)
from baige_omni.data.multimodal.ernie.image_preprocessor import (
    AdaptiveImageProcessor,
)
from baige_omni.data.multimodal.ernie.image_modification import (
...
class ErnieTaskEncoder(BaseTaskEncoder):
    ...
    def encode_multi_mix_qa(self, sample: MultiMixQASample) -> ErnieTaskSample:
        ...
        if images and len(image_meta) > 0:
            from baige_omni.data.multimodal.ernie.image_modification import VisionExample
