...
1. <OUTPUT_DIR>/metrics.jsonl (flushed by the Torch trainer, the most reliable):
   {"step_time": 15.098, "step": 1, "action_loss": 0.4337, "lr": 5e-08,
    "samples_per_sec": 0.53, "grad_norm": 4.1888, ...}

2. stdout training log (aligned with the Megatron format, loongforge/engine/torch/utils/logging.py):
