...
Kept local to the torch suite so that `tests/torch/` stays self-contained and
importable without the MCore E2E stack (which pulls in torch).
"""
...
def create_logger(log_dir=None, name="torch_regression", logfile_name="regression.log",
                  level=logging.INFO):
