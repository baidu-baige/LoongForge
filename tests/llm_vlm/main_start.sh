...
# cd into this script's own directory first: main.py's default configs_dir /
# optional_configs_dir / tasks_dir are resolved relative to the current
# working directory, not to main.py's location.
cd "${SCRIPT_DIR}"
