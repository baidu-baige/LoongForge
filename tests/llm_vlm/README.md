...
Configure in `tests/llm_vlm/main_start.sh`. **Uncomment** the desired mode and set variables as needed.
...
3. Run `bash tests/llm_vlm/main_start.sh`. Baselines will be saved under `tests/llm_vlm/baseline`.
