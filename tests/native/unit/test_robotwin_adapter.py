...
from loongforge.evaluation.action_decoders.ee6d import (
...
from loongforge.evaluation.adapters.robotwin import (
    ROBOTWIN_ACTION_REORDER,
    RoboTwinAdapter,
)
from loongforge.evaluation.payload_builders.pi05 import (
    adapt_to_pi_decode_state as _adapt_to_pi_decode_state,
)
from loongforge.evaluation.bridges.robotwin_policy import ModelClient
from loongforge.evaluation.orchestrator.runners.robotwin_runner import (
...
def test_robotwin_runner_writes_vla_eval_policy_config(tmp_path: pathlib.Path) -> None:
    ...
    assert "policy_name: loongforge.evaluation.bridges.robotwin_policy" in text
...
def test_robotwin_runner_builds_eval_policy_command() -> None:
    ...
    assert "loongforge.evaluation.bridges.robotwin_policy" in command
