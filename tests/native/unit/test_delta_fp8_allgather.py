...
from loongforge.engine.native.distributed import delta_fp8_allgather as delta_mod
from loongforge.engine.native.distributed import delta_fp8_comm
from loongforge.engine.native.distributed.delta_fp8_comm import triton as delta_triton
from loongforge.engine.native.training_args import TrainingArgs, build_arg_parser
from loongforge.engine.native.validators import validate
...
def test_quantize_dequantize_round_trip():
    from loongforge.engine.native.distributed.delta_fp8_comm import dequantize_add, quantize_delta
...
def test_param_major_error_feedback_updates_fused_fsdp_storage():
    from loongforge.engine.native.distributed.delta_fp8_comm import (
