...
Kept local to the native suite so that `tests/native/` stays self-contained and
...
def create_logger(log_dir=None, name="native_regression", logfile_name="regression.log",
                  level=logging.INFO):
