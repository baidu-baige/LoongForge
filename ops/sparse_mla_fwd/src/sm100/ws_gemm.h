...
{
  static_assert(M == 256 || M == 128, "SM100_MMA_MXF8F6F4_2x1SM_SS M-mode size should be 128 or 256 for 2 CTA cluster MMA.");
                  ...
                  cute::integral_constant<UMMA::ScaleIn, b_neg>>
{
             ...
             Tensor<TC, CLayout> const& C)
  {
    ...
    SM100_MMA_F8F6F4_SS_NOELECT::fma(desc_a, desc_b, tmem_c, uint32_t(traits.accumulate_), idesc);
  }
};
                  ...
                  cute::integral_constant<UMMA::ScaleIn, b_neg>>
{
             ...
             Tensor<TC, CLayout> const& C)
  {
    ...
    uint32_t tmem_c = raw_pointer_cast(D.data());
    uint64_t idesc = UMMA::make_runtime_instr_desc<>(traits.idesc_);
    SM100_MMA_F8F6F4_2x1SM_SS_NOELECT::fma(desc_a, desc_b, tmem_c, uint32_t(traits.accumulate_), idesc);
  }
};
}   // namespace cute
